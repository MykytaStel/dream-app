...
const DREAM_COPY_EN = {
  homeTitle: 'Dream log',
  homeSubtitle:
    'Capture quickly and revisit the patterns later.',
  ...
  homeSearchShowDetails: 'More search tools',
  homeSearchHideDetails: 'Less search tools',
...
const DREAM_COPY_UK: typeof DREAM_COPY_EN = {
  ...
  homeSubtitle:
    'Записуй швидко і повертайся до патернів пізніше.',
  ...
  homeSearchShowDetails: 'Більше інструментів',
  homeSearchHideDetails: 'Менше інструментів',
