...
const DREAM_COPY_EN = {
  ...
  archiveSubtitle:
    'Browse older dreams by month, then narrow that month by date or search when you need something specific.',
...
const DREAM_COPY_UK: typeof DREAM_COPY_EN = {
  ...
  archiveTitle: 'Архів',
  archiveSubtitle:
    'Переглядай старі сни по місяцях, а потім звужуй вибраний місяць датою або пошуком, коли треба знайти щось конкретне.',
