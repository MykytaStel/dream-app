...
const PRACTICE_COPY_EN = {
  ...
  // Questions, not filter labels. These fields borrowed their wording from the
  // archive filters, where "High distress" is a thing you filter by; above a
  // row of five numbers it read as a yes-or-no question with the answers
  // missing. The anchors name the ends, which five bare numbers never did.
  nightmareExplicitQuestion: 'Was it a nightmare?',
  nightmareDistressQuestion: 'How distressing was it?',
  nightmareDistressLow: 'Mild',
  nightmareDistressHigh: 'Severe',
  nightmareRecurringQuestion: 'Have you had this one before?',
  nightmareWokeQuestion: 'Did it wake you?',
  lucidRecallQuestion: 'How clearly do you recall it?',
  lucidRecallLow: 'Hazy',
  lucidRecallHigh: 'Vivid',
...
const PRACTICE_COPY_UK: PracticeCopy = {
  ...
  nightmareExplicitQuestion: 'Це був кошмар?',
  nightmareDistressQuestion: 'Наскільки важко це було?',
  nightmareDistressLow: 'Легко',
  nightmareDistressHigh: 'Дуже важко',
  nightmareRecurringQuestion: 'Такий сон уже снився?',
  nightmareWokeQuestion: 'Він тебе розбудив?',
  lucidRecallQuestion: 'Наскільки чітко ти його пам’ятаєш?',
  lucidRecallLow: 'Туманно',
