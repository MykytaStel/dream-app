...
const SETTINGS_COPY_EN = {
  ...
  transcriptionDescription:
    'Voice notes can be transcribed locally after a one-time model download.',
...
const SETTINGS_COPY_UK: typeof SETTINGS_COPY_EN = {
  ...
  transcriptionDescription:
    'Голосові нотатки можна транскрибувати локально після одноразового завантаження моделі.',
