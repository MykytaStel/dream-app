...
const SETTINGS_COPY_EN = {
  title: 'Settings',
  subtitle: 'Local-first controls for reminders, privacy, backups, and analysis.',
  sectionTitle: 'Workspace',
  sectionGeneral: 'General',
  sectionBackup: 'Backup',
  sectionTools: 'Tools',
  sectionGeneralHint: 'Language, reminder, and privacy basics.',
  sectionBackupHint: 'Export snapshots and review restore before changing local data.',
  ...
  scaleTestDescription: 'Generate sample dreams so you can stress-test Home, Archive, and Memory.',
...
const SETTINGS_COPY_UK: typeof SETTINGS_COPY_EN = {
  ...SETTINGS_COPY_EN,
  title: 'Налаштування',
  subtitle: 'Локальні керування нагадуваннями, приватністю, копіями й аналізом.',
  sectionTitle: 'Режим',
  sectionGeneral: 'Основне',
  sectionBackup: 'Копії',
  sectionTools: 'Інструменти',
  sectionGeneralHint: 'Мова, нагадування і базова приватність.',
  sectionBackupHint: 'Експорт копій і перегляд відновлення перед зміною локальних даних.',
  ...
  privacyDescription:
    'Дані про сни лишаються на пристрої. Акаунти і синхронізація поки вимкнені.',
  ...
  restoreModeReplaceHint:
    'Використати копію як нове локальне джерело даних.',
  restoreModeMergeHint:
  ...
  restoreDraftActionImportIfEmpty: 'Чернетка з копії імпортується, лише якщо локальна порожня',
  ...
  scaleTestDescription: 'Згенеруй тестові сни, щоб прогнати головний екран, Архів і Пам\'ять на великому обсязі.',
