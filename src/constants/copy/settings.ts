...
const SETTINGS_COPY_EN = {
  ...
  reminderPreviewWakeMeta: 'Open the reminder entry screen without waiting for the next notification.',
  ...
  privacySyncValue: 'Off for now',
  privacyAccountLabel: 'Account',
  privacyAccountValue: 'No sign-in needed',
...
const SETTINGS_COPY_UK: typeof SETTINGS_COPY_EN = {
  ...
  reminderPreviewWakeAction: 'Переглянути wake flow',
  reminderPreviewWakeMeta: 'Відкрий екран після нагадування без очікування наступного сповіщення.',
  ...
  privacySyncValue: 'Поки вимкнена',
  privacyAccountLabel: 'Акаунт',
  privacyAccountValue: 'Без входу',
