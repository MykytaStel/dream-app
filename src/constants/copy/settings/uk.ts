...
export const SETTINGS_COPY_UK: SettingsCopy = {
  ...
  privacyFootnote:
    'Якщо видалити застосунок, локальні записи, завантажена модель транскрипції і чернетки зникнуть разом із ним. Спершу зробіть експорт, якщо хочете зберегти.',
  ...
  privacyNoAccountNote:
    'Немає ані облікового запису, ані профілю. Офлайн застосунок повноцінний — підрахунки використання, нижче, єдине, що виходить саме, і його вимикає один перемикач.',
