...
const STATS_COPY_EN = {
  ...
  overviewActivityDescription: 'A quick rhythm of how often dreams were saved lately.',
  ...
  fingerprintDescription:
    'A quick portrait of what this slice feels like when the same signals keep coming back.',
  ...
  detailsDescription: 'Open the deeper numbers only when you need them.',
  ...
  coverageDescription: 'What in this slice is already easy to search or understand later.',
  ...
  attentionTitle: 'Add next',
  attentionDescription: 'The smallest additions that would make this slice richer.',
...
const STATS_COPY_UK: typeof STATS_COPY_EN = {
  ...
  overviewActivityDescription: 'Швидкий ритм того, як часто останнім часом зберігалися сни.',
  ...
  fingerprintDescription:
    'Швидкий портрет того, як відчувається цей зріз, коли ті самі сигнали постійно повертаються.',
  ...
  detailsDescription: 'Відкривай глибші цифри тільки коли вони справді потрібні.',
  ...
  coverageDescription: 'Що в цьому зрізі вже легко знайти або зрозуміти пізніше.',
  ...
  attentionTitle: 'Що додати далі',
  attentionDescription: 'Найменші кроки, які зроблять цей зріз змістовнішим.',
