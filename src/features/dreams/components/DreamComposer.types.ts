...
export type DreamComposerIntensityOption = ReturnType<
  typeof getDreamIntensityLevels
>[number];
export type DreamComposerLucidityOption = ReturnType<
  typeof getDreamLucidityLevels
>[number];
export type DreamComposerStressOption = ReturnType<
  typeof getDreamStressLevels
>[number];
export type DreamComposerWakeEmotionOption = ReturnType<
  typeof getDreamWakeEmotions
>[number];
