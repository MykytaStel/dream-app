        ...
        <Pressable style={styles.detailsToggleRow} onPress={onToggleExpanded}>
          ...
          <View style={styles.detailsTogglePill}>
            <Text style={styles.detailsTogglePillText}>
              {isExpanded
                ? copy.milestonesToggleHide
                : copy.milestonesToggleShow}
            </Text>
            <Ionicons
          ...
          >
            <View style={styles.teaserRow}>
              <View style={styles.teaserCard}>
                ...
                <Text
                  style={styles.teaserValue}
                >{`${overallLastSevenDays}/${weeklyGoalTarget}`}</Text>
